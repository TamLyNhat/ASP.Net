...
namespace TKHTTT.Areas.Admin.Controllers
{
    public class SachesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSach,MaTL,MaNXB,TenSach,TrangThai,GiaBia,HinhAnh")] Sach sach)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSach,MaTL,MaNXB,TenSach,TrangThai,GiaBia,HinhAnh")] Sach sach)
        {
            if (ModelState.IsValid)
            {
